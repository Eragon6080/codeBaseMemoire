...
public final class NotificationService
{
    ...
    /*
        ...
        in example.java. It is impossible to spawn a notification if the main stage attribute
        is null.
     */
     ...
     * Only used once in example.java at initialization. The parent stage should
