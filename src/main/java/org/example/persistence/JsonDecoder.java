 ...
 * as example no longer migrates versions. Storing and handling version numbers
...
{
	private static final String PREFIX_NODES = "org.example.diagram.nodes.";
	private static final String PREFIX_EDGES = "org.example.diagram.edges.";
