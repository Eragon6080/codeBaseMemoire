...
import org.example.application.Version;
import org.example.diagram.Diagram;
import org.example.geom.Rectangle;
import org.example.gui.DeserializationErrorAlert;
...
/**
 * Entry point for launching example.
 */
public final class example extends Application
{
	...
	public void start(Stage pStage) throws Exception 
	{
		 ...
		 * taskbar instead of the example-branded icon. To show the example
		...
		pStage.getScene().getStylesheets().add(getClass().getResource("org/example/example.css").toExternalForm());
