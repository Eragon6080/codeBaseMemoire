...
import static org.example.rendering.FontMetrics.DEFAULT_FONT_SIZE;
...
public final class UserPreferences
{
	...
	private UserPreferences()
	{
		for( BooleanPreference preference : BooleanPreference.values() )
		{
			aBooleanPreferences.put(preference, 
					Boolean.valueOf(Preferences.userNodeForPackage(example.class)
		...
		for( IntegerPreference preference : IntegerPreference.values() )
		{
			aIntegerPreferences.put( preference, 
					Integer.valueOf(Preferences.userNodeForPackage(example.class)
							.get(preference.name(), preference.getDefault())));
		}
	}
	...
	public void setBoolean(BooleanPreference pPreference, boolean pValue)
	{
		...
		Preferences.userNodeForPackage(example.class).put(pPreference.name(), Boolean.toString(pValue));
	...
	public void setInteger(IntegerPreference pPreference, int pValue)
	{
		...
		Preferences.userNodeForPackage(example.class).put(pPreference.name(), Integer.toString(pValue));
