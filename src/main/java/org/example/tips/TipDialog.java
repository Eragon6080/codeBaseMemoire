...
public class TipDialog 
{
	...
	private TipLoader.Tip aCurrentTip;
	...
	private Scene createScene() 
	{
		...
		TipLoader.Tip tip = TipLoader.loadTip(getUserPrefNextTipId());
	...
	private HBox createTipMenuButtons()
	{
		...
		{ 
			...
			TipLoader.Tip nextTip = TipLoader.loadTip(nextTipId);
			setUserPrefNextTip(aViewedTips.getNewNextTipOfTheDayId());
			setupNewTip(nextTip);
		});
		...
		{ 
			...
			TipLoader.Tip previousTip = TipLoader.loadTip(previousTipId);
	 ...
	 * @pre pTip != null
	 */
	private void setupNewTip(TipLoader.Tip pTip)
	{
		assert pTip != null;
	 ...
	 * @pre pTip != null
	 */
	private VBox getTipAsVBox(TipLoader.Tip pTip)
	{
		assert pTip != null;
	 ...
	 * @pre pTip!= null
	 */
	private static Text getTipTitleAsTextNode(TipLoader.Tip pTip)
	{
		assert pTip != null;
